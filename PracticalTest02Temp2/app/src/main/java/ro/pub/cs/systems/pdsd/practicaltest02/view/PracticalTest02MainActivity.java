...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class ConnectButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            // If serverPort field is empty, we return
    ...
    private DefinitionButtonClickListener definitionButtonClickListener = new DefinitionButtonClickListener();
    private class DefinitionButtonClickListener implements Button.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Server widgets onCreate
        serverPortEditText = (EditText) findViewById(R.id.server_port_edit_text);
        connectButton = (Button) findViewById(R.id.connect_button);
        connectButton.setOnClickListener(connectButtonClickListener);

        // Client widgets onCreate
        clientAddressEditText = (EditText) findViewById(R.id.client_address_edit_text);
        clientPortEditText = (EditText) findViewById(R.id.client_port_edit_text);
        clientWordEditText = (EditText) findViewById(R.id.client_word_edit_text);
        sendWordButton = (Button) findViewById(R.id.send_word_button);
        sendWordButton.setOnClickListener(definitionButtonClickListener);
